...
$DUHselect = $_SESSION["DUHselect"];
$DUCselect = $_SESSION["DUCselect"];
$ADSselect = $_SESSION["ADSselect"];
$TSGAselect = $_SESSION["TSGAselect"];
$CTSGAselect = $_SESSION["CTSGAselect"];
$ICEselect = $_SESSION["ICEselect"];
$SSLCselect = $_SESSION["SSLCselect"];
